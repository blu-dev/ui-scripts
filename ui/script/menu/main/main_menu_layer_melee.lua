...
button:add_id("MELEE", "NORMAL", 1)
button:add_id("MELEE", "TEAMCOMPE", 2)
button:add_id("MELEE", "TOURNAMENT", 3)
button:add_id("MELEE", "SPECIAL", 4)
button:add_id("MELEE", "OPTION", 5)
...
function value:initialize()
    ...
    self.howto_table = {}
    self.howto_table[button.MELEE_NORMAL] = {
        id = "UI_HOWTOPLAY_MELEE_NORMAL_TOP"
    }
