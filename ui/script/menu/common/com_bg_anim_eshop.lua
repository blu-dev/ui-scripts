--[[
FILE: com_bg_anim_eshop.lua
Reference Code: com_bg_anim_eshop.lc
...
The output disassembly of this file is guaranteed to match exactly that of com_bg_anim_eshop.lc
when unmodified.
]] --
local value = {}

function value:initialize (sub_anim_module)
    self.panes = get_panes(sub_anim_module, "set_parts_bg_eshop", "anim")
    for index, group_pane in ipairs(self.panes) do
        ...
        -- If 0 is less than or equal to index, and if index is less than 5
        ...
        -- If index is more than or equal to 10, and index is less than 15
        ...
        -- If index is more than or equal to 15, and index is less than 20
        ...
        -- If index is more than or equal to 20, and index is less than 25
        ...
        -- If index is more than or equal to 25, and index is less than 30
        ...
        -- If index is more than or equal to 30, and index is less than 35
        ...
        -- If index is more than or equal to 35
        if 35 <= index then
            -- Set sx
    ...
    for index, group_pane in ipairs(self.panes) do
        ...
        -- Position Variables (these calculations are correct but idk what they do)
